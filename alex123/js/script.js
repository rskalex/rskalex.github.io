...
let panel = document.querySelectorAll('p'),
    width = window.getComputedStyle(document.querySelector('.wrapper')).width
    console.log(width)
if(+width.slice(0, width.length - 2) <= 768){
    console.log(panel)
    panel.forEach(item => {
        item.innerHTML = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis debitis doloribus nam a pariatur necessitatibus delectus, atque maiores' + '...'
    })
}